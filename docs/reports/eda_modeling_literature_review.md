...
## Technical Summary
- Bộ dữ liệu modeling có 5,485 ngày, từ 2011-07-06 đến 2026-07-11. Target chính là return sau spread: `buy_price_exit / sell_price_t - 1` cho horizon 1, 3 và 5 tháng lịch.
...
- Horizon 1 tháng: `sarimax_exog` có MAE return trung bình 0.0403, directional accuracy 48.08%.
- Horizon 3 tháng: `naive_zero_return` có MAE return trung bình 0.0957, directional accuracy 0.55%.
- Horizon 5 tháng: `lightgbm_mean` có MAE return trung bình 0.1224, directional accuracy 47.68%.

Decision-rule mặc định dùng `P(net_return > 0) >= 0.60` và q10 return không thấp hơn `-5%`.

- 1 tháng, test: 32/365 ngày phát tín hiệu; return trung bình trên ngày mua 0.0134.
- 1 tháng, validation: 0/365 ngày phát tín hiệu; return trung bình trên ngày mua n/a (không có ngày phát tín hiệu).
- 3 tháng, test: 328/466 ngày phát tín hiệu; return trung bình trên ngày mua 0.0987.
- 3 tháng, validation: 306/731 ngày phát tín hiệu; return trung bình trên ngày mua 0.0146.
- 5 tháng, test: 407/407 ngày phát tín hiệu; return trung bình trên ngày mua 0.1995.
- 5 tháng, validation: 366/731 ngày phát tín hiệu; return trung bình trên ngày mua 0.0705.
